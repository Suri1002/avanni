...
if (isset($_POST['submit'])) {
  ...
  $sql = mysqli_query($conn, "INSERT INTO `products`(`Name`, `Description`, `Image`, `Price`) VALUES ('$pname','$pdescript','$imageName','$pprice')");
        ...
        <div class="col-lg-6 default-padding">
         <div class="card">
           ...
           <div class="form-group mt-4">
            ...
            <input type="text" name="pdescript" class="form-control" id="input-2" placeholder="Enter Product Description" required>
           </div>
           <div class="form-group mt-4">
