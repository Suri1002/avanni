...
<!-- Mirrored from webhunt.store/themeforest/farmi/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Feb 2021 18:07:17 GMT -->
<head>
    <!-- ========== Meta Tags ========== -->
    <meta charset="utf-8">
    ...
    <!-- ========== Page Title ========== -->
    <title>Avanni - Organic Farm Agriculture Template</title>
                        ...
                        <div class="pf-item">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <a href="assets/img/gallery/6.jpg" class="item popup-gallery"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Item -->
                    ...
                    <div class="pf-item">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <a href="assets/img/gallery/7.jpg" class="item popup-gallery"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="pf-item">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <a href="assets/img/gallery/8.jpg" class="item popup-gallery"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
                    ...
                    <div class="pf-item">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <a href="assets/img/gallery/11.jpg" class="item popup-gallery"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Item -->
